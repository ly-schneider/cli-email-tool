...
def fetch_emails():
    ...
    # Access the rss-feed
    response = requests.get("https://mail.google.com/mail/feed/atom", auth=(email, password))
    ...
    if not entries:
        ...
        for entry in entries:
            ...
            author_email = entry.find('{http://purl.org/atom/ns#}author').find('{http://purl.org/atom/ns#}email').text
