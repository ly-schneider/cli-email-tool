...
def main():
    ...
    if not from_email or not password:
        print("E-Mail Adresse oder Gmail App-Code ist leer. Bitte konfigurieren Sie die E-Mail Adresse und das Passwort in settings.txt")
        return

    print()
    to_email = input("Gebe die E-Mail Adresse ein, an die die E-Mail gesendet werden soll: ")
    ...
    body = ""
    while True:
        line = input("Gebe den Inhalt der E-Mail ein (oder 'SEND' um zu senden der E-Mail): ")
        if line == "SEND":
            break
        body += line + "\n"
